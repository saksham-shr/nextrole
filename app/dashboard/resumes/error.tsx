...
export default function ResumesError({
  ...
  return (
    <div className="flex min-h-[40vh] flex-col items-center justify-center gap-3 text-center">
      <p className="text-[14px] font-medium text-[var(--foreground)]">Failed to load resumes</p>
      <p className="text-[13px] text-[var(--muted-foreground)]">Your files are safe — this is a display error.</p>
      <button
        onClick={reset}
